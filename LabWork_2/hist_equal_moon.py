...
parser.add_argument('--input', help='Path to input image.', default='moon.png')
...
cv.imshow('equalized_moon.png', src)
cv.imwrite('equalized_moon.png', src)
cv.imshow('moonhist', histImage)
cv.waitKey()